...
class ScreenerEngine:
    ...
    def apply_filters(self, df, filters):
        ...
        for key, value in filters.items():
            ...
            if (
                ...
                and "broad_sector" in filtered_df.columns
            ):
    ...
    def calculate_composite_quality_score(self, df):
                            ...
                            score_df["composite_quality_score"] = score_df[
    ...
    def run_screener(self, preset_name):
        ...
        filtered_df = self.calculate_composite_quality_score(
            filtered_df
        )
